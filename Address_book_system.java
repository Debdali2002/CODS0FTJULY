...
Scanner sc = new Scanner(System.in);
 ...
 public Persons Contact1(){
        ...
        contact1.setName("Avantika");
        contact1.setAge(20);
        contact1.setPhonenum(1122334455);
        contact1.setMail("abcd9021@outlook.com");
        contact1.setGender("Female");
        contact1.setAddress("Gorakhpur,India");
    return contact1;
    }
    public Persons Contact2(){
        Persons contact2 = new Persons();
       
        contact2.setName("Mahesh");
        contact2.setAge(20);
        contact2.setPhonenum(311499367);
        contact2.setMail("mhsh9048@gmail.com");
        contact2.setGender("Male");
        contact2.setAddress("Delhi,India");
    return contact2;
    }
public Persons Contact3(){
        Persons contact3 = new Persons();
       
        contact3.setName("Ramesh");
        contact3.setAge(20);
        contact3.setPhonenum(328962675);
        contact3.setMail("rameshlal@outlook.com");
        contact3.setGender("Male");
        contact3.setAddress("Kanpur,India");
    return contact3;
    }
    ...
    public Persons Contact4(){
        ...
        contact4.setName("Meera");
        contact4.setAge(20);
        contact4.setPhonenum(336696267);
        contact4.setMail("mera76@gmail.com");
        contact4.setGender("Female");
        contact4.setAddress("Lucknow,India");
    return contact4;
    }
